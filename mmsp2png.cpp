...
// Code is modifed mostly base on the original work by Trevor Keller at
// https://github.com/mesoscale/mmsp/blob/master/utility/mmsp2png.cpp 
...
template <int dim, typename T> void convert_scalars(const MMSP::grid<dim,T>& GRID,
                                                    ...
                                                    const std::set<double>& levelset, const int& lvlfield, const double& contol, const unsigned int& bufsize, unsigned char* buffer)
{
	double min= 1.0; // hard coded for 200 grains     //  zoomin;
	double max= 200; // hard coded for 200 grains     //  zoomax;
